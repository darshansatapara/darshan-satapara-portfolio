...
export default function ServicesPage() {
  ...
  return (
    <main className="min-h-screen bg-[#fffdf5] py-20 px-4 md:px-8 font-mono text-black">
        <div className="text-center mb-16"><span className="inline-block bg-black text-white px-6 py-2 font-black uppercase tracking-widest shadow-[6px_6px_0_#4ecdc4]">What I build</span><h1 className="text-5xl md:text-8xl font-black uppercase tracking-tighter mt-8">Ideas into<br /><span className="bg-[#ff6b6b] text-white px-3">working systems</span></h1></div>
